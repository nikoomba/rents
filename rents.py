...
#geocode("Glasgow") #note '%20' only needs to be in for testing purposes since the browser will automatically change a space in to '%20' when sending the request to the handler. 
